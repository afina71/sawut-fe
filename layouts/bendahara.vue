    ...
    >
      <v-list>
        ...
        <v-list-item-group v-model="selectedItem" color="primary">
          ...
          <v-list-item to="/bendahara/pengaturan">
            <v-list-item-icon>
    ...
    menus: [
      {
        ...
        page: '/bendahara/beranda',
      },
      {
        title: 'Penerimaan Wakaf',
        icon: 'mdi-inbox-arrow-down-outline',
        page: '/bendahara/penerimaanWakaf',
      },
      {
        title: 'Pengelolaan Wakaf',
        icon: 'mdi-chart-box-outline',
        page: '/bendahara/pengelolaanWakaf',
      },
      {
        title: 'Penyaluran Manfaat',
        icon: 'mdi-handshake-outline',
        page: '/bendahara/penyaluranManfaat',
      },
      {
        title: 'Pengajuan Biaya',
        icon: 'mdi-swap-horizontal-circle-outline',
        page: '/bendahara/pengajuanBiaya',
      },
      {
        title: 'Pelunasan Piutang',
        icon: 'mdi-cash-check',
        page: '/bendahara/pelunasanPiutang',
      },
    ],
    submenu1: [
      { title: 'Posisi Keuangan', page: '/bendahara/laporan/posisiKeuangan' },
      {
        title: 'Rincian Aset Wakaf',
        page: '/bendahara/laporan/rincianAsetWakaf',
      },
      { title: 'Aktivitas', page: '/bendahara/laporan/aktivitas' },
      { title: 'Arus Kas', page: '/bendahara/laporan/arusKas' },
    ],
    submenu2: [
      {
        title: 'Data Aset Tetap',
        page: '/bendahara/dataLainnya/dataAsetTetap',
      },
      {
        title: 'Data Utang',
        page: '/bendahara/dataLainnya/dataUtang',
      },
    ],
    mini: true,
    defaultItem: {
